...
class Fish{
  constructor(img_file_name) {
    ...
    elem.id = "elem"; elem.height = "300"; elem.width = "400";
    elem.id = "fish-"+ String(Math.random());
    elem.style.position = "absolute"; elem.style.left = "0%"; elem.style.top = "0%";
    elem.style.left = "0%"; elem.style.top = "0%";
    elem.src =  BASE_URL + `/uploads/` + img_file_name;
    // this.mat = cv.imread(elem)
    // console.log(this.mat)

    this.parent = document.getElementById("root")
    // this.parent = document.getElementById("aquarium")
